...
const ICON_RECORD_BUTTON = new Icon(require('../assets/images/record_button.png'), 15, 15);
const ICON_RECORDING = new Icon(require('../assets/images/record_icon.png'), 15, 15);

const ICON_PLAY_BUTTON = new Icon(require('../assets/images/play_button.png'), 15, 15);
const ICON_PAUSE_BUTTON = new Icon(require('../assets/images/pause_button.png'), 15, 15);
const ICON_STOP_BUTTON = new Icon(require('../assets/images/stop_button.png'), 15, 15);

const ICON_MUTED_BUTTON = new Icon(require('../assets/images/muted_button.png'), 15, 15);
const ICON_UNMUTED_BUTTON = new Icon(require('../assets/images/unmuted_button.png'), 15, 15);

const ICON_TRACK_1 = new Icon(require('../assets/images/track_1.png'), 15, 15);
const ICON_THUMB_1 = new Icon(require('../assets/images/thumb_1.png'), 15, 15);
const ICON_THUMB_2 = new Icon(require('../assets/images/thumb_2.png'), 15, 15);
...
Expo.registerRootComponent(AudioScreen);